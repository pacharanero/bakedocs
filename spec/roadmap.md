...
- [~] **R13 - Add a release-backed bootstrap installer**: deterministic versioned runtime payloads, `SHA256SUMS`, guarded Linux/macOS bootstrap installation, dependency routes, adversarial tests, and manually approved tagged release automation are implemented. Publishing and smoke-testing the first approved GitHub Release remains.
